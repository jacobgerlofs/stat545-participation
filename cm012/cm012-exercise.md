...
*Factors allow us to categorize the data in the order we want (low to high in this case, otherwise it would be alphabetical)
*Drop = FALSE argument ensures that when their are no observations in a given category, it won't be removed from the plot (Very low, in this case)
